...
<body>
    <div class="container">
        <h1 style="font-size:20pt">REGISTOR DE USUARIOS</h1>

        <h3>Datos de Usuarios</h3>
        <br />
        <button class="btn btn-success" onclick="add_usuario()"><i class="glyphicon glyphicon-plus"></i> Adicionar</button>
        ...
        <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th style="width:50px;">Carnet</th>
                    <th style="width:100px;">Nombre</th>
                    <th style="width:100px;">Paterno</th>
                    <th style="width:100px;">Materno</th>
...
function edit_usuario(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="id"]').val(data.usu_codigo);
			$('[name="carnet"]').val(data.usu_ci);
            $('[name="nombres"]').val(data.usu_nombre);
            $('[name="paterno"]').val(data.usu_paterno);
            $('[name="materno"]').val(data.usu_materno);
            $('[name="celular"]').val(data.usu_celular);
			$('[name="nivel"]').val(data.niv_codigo);
			$('[name="estado"]').val(data.usu_estado);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Usuario Formulario</h3>
            </div>

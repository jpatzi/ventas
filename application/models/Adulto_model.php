...
class Adulto_model extends CI_Model {
	...
	var $table = 'adulto';
	var $column_order = array('adu_asignacion','adu_carnet','adu_nombres','adu_paterno','adu_materno','adu_estado',null); //
	var $column_search = array('adu_asignacion','adu_carnet','adu_nombres'); //
	var $order = array('adu_codigo' => 'desc'); // default order 
  ...
  //////////////////
  public function estadocivil_get()
    {
        $query = $this->db->query("SELECT * FROM estadocivil");
        return $query->result();
    }
  public function parentesco_get()
    {
